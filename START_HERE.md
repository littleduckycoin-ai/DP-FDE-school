...
> 请在线读取 https://github.com/littleduckycoin-ai/DP-FDE-school/blob/main/START_HERE.md ，并继续读取其中的school-guide教学规则。每轮需要资料时读取线上当前版本，不克隆仓库、不建立本地教材副本。先用10分钟带我学习案例04：讲清行业痛点、FDE做了什么、交付了什么、效果与限制，再围绕我的判断展开讨论。案例证据请链接到原访谈PDF的具体物理页，不要把JSON链接作为默认引用。
